			...
			<div class="col-md-2">
				<div class="list-group">
					<a href="${pageContext.request.contextPath}/student?method=pageList" class="list-group-item"> 学生管理 </a>
					 ...
					 <a href="${pageContext.request.contextPath}/student?method=getAddPage" class="list-group-item active">学生添加</a>
				</div>
			</div>
			<div class="col-md-10">
				<div>
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation" ><a
							...
							>学生搜索</a></li>
						<li role="presentation" class="active"><a href="${pageContext.request.contextPath}/student?method=getAddPage"
							class="list-group-item " >学生添加</a></li>
					</ul>
				</div>
